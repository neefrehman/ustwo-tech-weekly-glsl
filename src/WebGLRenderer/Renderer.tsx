...
export const WebGLRenderer = ({
    ...
    // Default vertex shader used to pass our uv co-ordinate varying to the fragment shader
    ...
    useEffect(() => {
        ...
        setTimeout(() => { canvas.width += 1; canvas.width -= 1; }, 1); /* prettier-ignore */
